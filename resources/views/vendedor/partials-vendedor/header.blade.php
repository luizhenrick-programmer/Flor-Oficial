    ...
    <div class="container-fluid">
        <div class="flex px-5">
            <div class="d-flex align-items-center">
                <a href="{{ route('vendedor.dashboard') }}" class="logo">
        ...
        <div class="navbar-nav order-md-last">
            ...
            <div class="d-none d-md-flex items-center me-2">
                <div class="nav-item d-none d-md-flex me-2">
                    <a class="btn text-white" type="button" href="{{ route('vendedor.dashboard') }}">
                ...
                <div class="nav-item d-none d-md-flex me-2">
                    <a class="btn text-white" type="button" href="{{ route('vendendor.dashboard') }}">
                        <div class="position-relative d-inline-block">
