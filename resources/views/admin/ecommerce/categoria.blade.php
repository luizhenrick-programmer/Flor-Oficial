        ...
        <div class="flex flex-col bg-gray-800 shadow-md rounded-lg p-2">
            <div class="w-full flex items-center justify-between flex-wrap gap-1">
                ...
                <div class="flex items-center gap-1">
                    ...
                    <a href="{{ route('e-commerce.criar_categoria') }}" class="btn bg-violet-600 text-white shadow-md rounded-md border border-gray-600 py-2 px-4 hover:bg-violet-800 hover:text-black">
            ...
            @else
                <p class="mt-4 alert alert-warning">Nenhuma categoria cadastrada</p>
            @endif
