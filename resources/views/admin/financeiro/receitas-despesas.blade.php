...
<div class="container-xl flex flex-col py-5">
    ...
    <div class="bg-gray-700 rounded-lg border-l-4 border-green-500 text-gray-200 mt-4 p-3" role="alert">
        <div class="flex items-center">
            ...
            <x-text color="gray-200" size="md">Olá {{ Auth::user()->name }}, bem-vindo ao relatório financeiro!</x-text>
        </div>
    </div>
