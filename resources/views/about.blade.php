...
@section('content')
    ...
    <div class="container my-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <img src="{{ asset('assets/images/lojaLoja.jpg' )}}" alt="Imagem História" class="img-fluid rounded">
            </div>
        </div>
        ...
        <div class="row my-4">
            <div class="col-md-4">
                ...
                <img src="{{ asset('assets/images/fotoSobreFour.jpg' )}}" alt="Imagem Missão" class="img-fluid rounded about-text">
            </div>
            <div class="col-md-4">
                <h3>Nossa Visão</h3>
                <p>Ser referência no mercado da moda sustentável, criando produtos que inspirem uma conexão mais profunda com a natureza e promovam um estilo de vida mais consciente. balblalalalaalalalalalalalalalalalallal</p>
                <img src="{{ asset('assets/images/fotoSobre.jpg' )}}" alt="Imagem Visão" class="img-fluid rounded about-text">
            </div>
            <div class="col-md-4">
                <h3>A Empresa</h3>
                ...
                <img src="{{ asset('assets/images/fotoSobreTree.jpg' )}}" alt="Imagem Empresa" class="img-fluid rounded about-text">
            </div>
        </div>
    </div>
